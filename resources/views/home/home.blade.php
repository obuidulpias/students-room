                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {!! Form::open(['route'=>'student-sign-up', 'method'=>'POST', 'id'=>'register-form', 'role'=>'form' ]) !!}
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="student_id" id="student_id" tabindex="1" class="form-control" placeholder="ID Number" value="">
                                </div>
                                <div class="form-group">
                                    <input type="number" name="phone_number" id="phone_number" tabindex="1" class="form-control" placeholder="Phone Number" value="">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email_address" id="email_address" tabindex="1" class="form-control" placeholder="Email Address" value="">
                                </div>
